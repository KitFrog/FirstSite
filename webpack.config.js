...
const paths = {
    src: path.resolve(__dirname, './scripts'), // исходные файлы JS
    build: path.resolve(__dirname, './build'), // собранный проект для выкладывания на хостинг
    static: path.resolve(__dirname, './'), // статичные файлы, которые копируются в build
};
...
module.exports = {
    ...
    entry: [paths.src + '/Inline-Babel-Script.js'], // точка входа
    output: {
            ...
            patterns: [
              {
                ...
                to: paths.build,
                globOptions: {
                  ignore: ['**/index.html', '**/test.js', '**/.gitignore'] // кроме index.html
                }
              }
            ],
        }),
